...
fn test_dialogue_ffi_round_trip() {
    unsafe {
        ...
        // Load dialogue
        let dialogue_path = c(&project_root()
        ...
        assert!(
            json.contains("crossing_intro"),
            "should contain intro entry id"
        );
        ...
        assert!(
            json.contains("crossing_scouts"),
            "should contain scouts entry"
        );
